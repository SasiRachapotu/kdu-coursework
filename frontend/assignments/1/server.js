...
floatingButton.addEventListener("click", (e)=>{
    ...
    let tweetBox = e.target.parentNode.parentNode.parentNode.querySelector(".tweet-box");
...
let mobilePostNavIcons = document.createElementNS("http://www.w3.org/2000/svg", "svg");
...
// Create an svg element
 let mobilePostIconSvg = document.createElementNS("http://www.w3.org/2000/svg", "svg");
...
// Create an svg element
 mobilePostIconSvg = document.createElementNS("http://www.w3.org/2000/svg", "svg");
mobilePostIconSvg.setAttribute("viewBox", "0 0 24 24");
mobilePostIconSvg.setAttribute("aria-hidden", "true");
mobilePostIconSvg.classList.add("mobile-post-icon");
