  ...
  return (
    <div className={`item ${listItem.checked===true?"item-strike" : ""}`}>
      ...
      <div className="delete-check-box">
        <input type="checkbox" id="checkbox" className="checkbox" data-testid="checkbox" onChange={checkHandler}></input>
      <button id="delete-btn" data-testid="Delete-Btn" className="delete" onClick={deleteHandler}>
        X
      </button>
      </div>
    </div>
