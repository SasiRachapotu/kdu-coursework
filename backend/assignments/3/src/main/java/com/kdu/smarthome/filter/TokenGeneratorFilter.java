...
public class TokenGeneratorFilter extends OncePerRequestFilter {
    ...
    // Authorization header which is used to set and receive the token
    public static final String JWT_HEADER = "Authorization";
    // Jwt key used for encryption
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (null != authentication) {
            ...
            // Bearer token is used so that the token don't get corrupted
    ...
    // Function to return the roles comma separated
